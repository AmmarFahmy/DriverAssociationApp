...
public class LoginServletUser extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet LoginServletUser</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet LoginServletUser at " + request.getContextPath() + "</h1>");
            
            String logUserName = request.getParameter("email");
            ...
            if(user!=null){
                ...
                out.println("No User Privilages Found");
