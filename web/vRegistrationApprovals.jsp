      ...
      <div class="yoo-sidebar-nav">
        <ul class="yoo-sidebar-nav-list yoo-mp0">
          ...
          <li>
           ...
           <li>
            <a href="claimApprovals.jsp">
              <span class="yoo-sidebar-link-title">
                <span class="yoo-sidebar-link-icon yoo-style1"><ion-icon name="duplicate"></ion-icon></span>
                <span class="yoo-sidebar-link-text">Claim Approvals</span>
              </span>
            </a>
          </li>
          <li>
  ...
  <div class="yoo-content yoo-style1">
    ...
    <div class="container-fluid">
      <div class="yoo-uikits-heading">
        <h2 class="yoo-uikits-title">Vehicle Registration Approvals</h2>
      </div>
    </div>
    <div class="yoo-height-b30 yoo-height-lg-b30"></div>
    <div class="container-fluid">
          ...
          <div class="yoo-card yoo-style1">
            <div class="yoo-card-heading">
              <div class="yoo-card-heading-left">
                <h2 class="yoo-card-title"><span class="yoo-card-title-icon yoo-blue-bg"><ion-icon name="browsers"></ion-icon></span>VEHICLE DATA</h2>
              </div>
            </div>
                  ...
                  <div class="yoo-table yoo-style1 yoo-type2">
                    <table class="table table-bordered">
                      <thead>
                        ...
                        String sql ="SELECT * FROM VEHICLE_REG";
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>
                              <span class="yoo-base-color1"><%=rs.getString("BRAND") %></span>
                          </td>
                          <td>
                            <span class="yoo-base-color1"><%=rs.getString("CHASSIS_NUMBER") %></span>
                          </td>
                          <td>
                            <span class="yoo-base-color1"><%=rs.getString("ENGINE_NUMBER") %></span>
                          </td>
                          <td>
                            <span class="yoo-base-color1"><%=rs.getString("TYPE_OF_VEHICLE") %></span>
                          </td>
                          <td>
                              <span class="yoo-base-color1"><%=rs.getString("MANUFACTURER_YEAR") %></span>
                          </td>
                          <td>
                              <span class="yoo-base-color1"><%=rs.getString("FLOOD_COVER") %></span>
                          </td>
                          <td>
                              <span class="yoo-base-color1"><%=rs.getString("PASSENGER") %></span>
                          </td>
                          <td>
                              <span class="yoo-base-color1"><%=rs.getString("VEHICLE_NUMBER") %></span>
                          </td>
                          <td>
                              <span class="yoo-base-color1"><%=rs.getString("TOTAL") %></span>
                          </td>
                          <td>
                              <input type="submit" value="Approve" class="btn btn-primary btn-sm" data-ripple="ripple" data-ripple-color="#fff" name="">
                          </td>
                        </tr>
                      </tbody>
                        <% 
