<%-- 
    Document   : claimApprovals
    Created on : Sep 7, 2020, 6:19:02 PM
    Author     : SAPNI
--%>
  ...
  <div class="yoo-content yoo-style1">
    ...
    <div class="container-fluid">
      <div class="yoo-uikits-heading">
        <h2 class="yoo-uikits-title">Claims Approvals</h2>
      </div>
    </div>
    <div class="yoo-height-b30 yoo-height-lg-b30"></div>
    <div class="container-fluid">
          ...
          <div class="yoo-card yoo-style1">
            <div class="yoo-card-heading">
              <div class="yoo-card-heading-left">
                <h2 class="yoo-card-title"><span class="yoo-card-title-icon yoo-blue-bg"><ion-icon name="browsers"></ion-icon></span>CLAIMS DATA</h2>
              </div>
            </div>
                    ...
                    <table class="table table-bordered">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>
                              <span class="yoo-base-color1"><%=rs.getString("FULL_NAME") %></span>
                          </td>
                          <td>
                            <span class="yoo-base-color1"><%=rs.getString("REASON") %></span>
                          </td>
                          <td>
                            <span class="yoo-base-color1"><%=rs.getString("CLAIM_DATE") %></span>
                          </td>
                          <td>
                            <span class="yoo-base-color1"><%=rs.getString("CLAIM_AMOUNT") %></span>
                          </td>
                          <td>
                              <span class="yoo-base-color1"><%=rs.getString("PAID_AMOUNT") %></span>
                          </td>
                          <td>
                              <span class="yoo-base-color1"><%=rs.getString("PAID_DATE") %></span>
                          </td>
                          <td>
                              <span class="yoo-base-color1"><%=rs.getString("STATUS") %></span>
                          </td>                          
                          <td>
